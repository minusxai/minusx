...
from .tools import ReadFiles, EditFile, ExecuteQuery, PublishAll, LoadSkill, FuzzyMatch
...
class AnalystAgent(Agent):
    ...
    def _get_available_tools(self):
        ...
        return [ReadFiles, EditFile, ExecuteQuery, PublishAll, Navigate, Clarify, SearchDBSchema, SearchFiles, CreateFile, LoadSkill, FuzzyMatch]
...
class SlackAgent(AnalystAgent):
    ...
    def _get_available_tools(self):
        ...
        if len(self.tool_thread) >= MAX_STEPS_LOWER_LEVEL - 5:
            return []
        return [ReadFiles, ExecuteQuery, SearchDBSchema, SearchFiles, LoadSkill, FuzzyMatch]
