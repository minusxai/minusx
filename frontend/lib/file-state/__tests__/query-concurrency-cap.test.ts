...
const testStore = configureStore({
  ...
  preloadedState: {
    ...
    configs: { config: {} as any, loadedAt: null, disableAppStateImages: false, maxConcurrentQueries: CAP, queryTimeoutMs: 120000, creditsEnabled: false, egressIps: [], vizTemplates: {} },
  },
});
vi.mock('@/store/store', () => ({
