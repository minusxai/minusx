...
const testStore = configureStore({
  ...
  preloadedState: {
    ...
    configs: { config: {} as any, loadedAt: null, disableAppStateImages: false, maxConcurrentQueries: CAP, queryTimeoutMs: 120000, creditsEnabled: false, showModelSettings: false },
  },
});
vi.mock('@/store/store', () => ({
