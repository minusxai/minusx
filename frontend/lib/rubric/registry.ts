 ...
 * categories stay unassessed rather than receiving a misleading 5/5. All current rubric file
 * types are deterministic-only at runtime; cataloged LLM checks are paused.
 */
