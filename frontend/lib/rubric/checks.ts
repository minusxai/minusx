...
export const DETERMINISTIC_CHECKS: Record<RubricFileType, RubricCheck[]> = {
  ...
  story: [
    ...
    { ruleId: 'story.typed-number', label: 'No hardcoded metrics', category: 'correctness', severity: 'warn' },
    { ruleId: 'story.undeclared-param', label: 'Params declared', category: 'correctness', severity: 'error' },
    { ruleId: 'story.grid-content-invalid', label: 'Grid content is visible', category: 'correctness', severity: 'error' },
    { ruleId: 'story.grid-overlap', label: 'Grid items do not overlap', category: 'correctness', severity: 'warn' },
    { ruleId: 'story.no-headline', label: 'Has a headline', category: 'clarity', severity: 'warn' },
    { ruleId: 'story.no-lead', label: 'Has a lead description', category: 'clarity', severity: 'warn' },
    { ruleId: 'story.embed-too-narrow', label: 'Charts wide enough', category: 'clarity', severity: 'error' },
    { ruleId: 'story.modern-root-incomplete', label: 'Modern root is responsive', category: 'clarity', severity: 'warn' },
...
export const LLM_CHECKS: Record<RubricFileType, LlmCheck[]> = {
  ...
  story: [
    { id: 'single-lead', category: 'aesthetics', severity: 'error', status: 'paused', label: 'One clear lead',
    ...
    { id: 'evidence-supports-claims', category: 'aesthetics', severity: 'error', status: 'paused', label: 'Claims are supported',
    ...
    { id: 'headlines-are-findings', category: 'aesthetics', severity: 'warn', status: 'paused', label: 'Headlines state findings',
    ...
    { id: 'frame-carries-insight', category: 'aesthetics', severity: 'warn', status: 'paused', label: 'Frame carries insight',
    ...
    { id: 'embeds-well-sized', category: 'aesthetics', severity: 'warn', status: 'paused', label: 'Embeds well-sized',
    ...
    { id: 'charts-render-cleanly', category: 'aesthetics', severity: 'warn', status: 'paused', label: 'Charts render cleanly',
    ...
    { id: 'ugly-empty-space-alignment', category: 'aesthetics', severity: 'error', status: 'paused', label: 'No ugly empty space',
    ...
    { id: 'readable-charts', category: 'aesthetics', severity: 'error', status: 'paused', label: 'Charts are readable',
    ...
    { id: 'text-readable', category: 'aesthetics', severity: 'error', status: 'paused', label: 'Text is readable',
    ...
    { id: 'no-hand-drawn-charts', category: 'aesthetics', severity: 'error', status: 'paused', label: 'No hand-drawn charts',
    ...
    { id: 'harmonious-chart-body', category: 'aesthetics', severity: 'warn', status: 'paused', label: 'Charts harmonize with the body',
    ...
    { id: 'deliberate-palette', category: 'aesthetics', severity: 'warn', status: 'paused', label: 'Deliberate palette',
    ...
    { id: 'typographic-craft', category: 'aesthetics', severity: 'warn', status: 'paused', label: 'Typographic craft',
