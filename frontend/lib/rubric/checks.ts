...
export const LLM_CHECKS: Record<RubricFileType, LlmCheck[]> = {
  ...
  dashboard: [
    ...
    { id: 'tiles-readable', category: 'clarity', severity: 'warn', label: 'Readable at tile size',
      question: 'Each chart is the right type and legible at its tile size (labels/values readable). PASS if all tiles are readable.',
