/**
 * Validates that workspace-template.json contains only schema-valid question and dashboard documents.
...
import workspaceTemplate from '../../database/workspace-template.json';
