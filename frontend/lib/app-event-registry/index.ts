...
appEventRegistry.subscribe(AppEvents.QUERY_EXECUTED,           p => trackQueryExecutionEvent({ queryHash: p.queryHash, fileId: p.fileId, query: p.query, params: p.params, schemaContext: p.schemaContext, databaseName: p.databaseName, durationMs: p.durationMs, rowCount: p.rowCount, colCount: p.colCount, wasCacheHit: p.wasCacheHit, error: p.error, userId: p.userId }));
