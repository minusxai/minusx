...
appEventRegistry.subscribe(AppEvents.FILE_CREATED,             p => notifyAppEvent('file:created',             p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.FILE_VIEWED,              p => notifyAppEvent('file:viewed',              p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.FILE_VIEWED_AS_REFERENCE, p => notifyAppEvent('file:viewed_as_reference', p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.FILE_UPDATED,             p => notifyAppEvent('file:updated',             p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.FILE_DELETED,             p => notifyAppEvent('file:deleted',             p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.FOLDER_CREATED,           p => notifyAppEvent('folder:created',           p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.LLM_CALL,                 p => notifyAppEvent('llm:call',                 p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.QUERY_EXECUTED,           p => notifyAppEvent('query:executed',           p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.JOB_CRON_SUCCEEDED,       p => notifyAppEvent('job:cron_succeeded',       p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.JOB_CRON_FAILED,          p => notifyAppEvent('job:cron_failed',          p as unknown as Record<string, unknown>));
appEventRegistry.subscribe(AppEvents.MCP_TOOL_CALL,            p => notifyAppEvent('mcp:tool_call',            p as unknown as Record<string, unknown>));
