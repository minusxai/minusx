...
import { DatabaseWithSchema, ContextVersion, DocEntry, MetricDef, TableAnnotation, SkillEntry, Whitelist } from '@/lib/types';
...
export async function computeSchemaFromWhitelist(
  ...
  if (isRoot) {
    ...
    return { fullSchema, parentSchema: allConnections, fullDocs: [], fullMetrics: [], fullAnnotations: [], fullSkills: [] };
  }
  ...
  return { fullSchema, parentSchema: parentOffering, fullDocs, fullMetrics, fullAnnotations, fullSkills };
}
