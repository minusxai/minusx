...
export const CONNECTION_TYPE_GROUPS = [
  {
    id: 'external-engine',
    title: 'Your Engine',
    description: '{{agentName}} connects to your existing database or warehouse and queries it in place.',
  },
  {
    id: 'minusx-warehouse',
    title: '{{agentName}} Warehouse',
    description: 'For files, public sheets, and APIs, {{agentName}} creates and manages the warehouse for you.',
  },
  {
    id: 'coming-soon',
    title: 'Coming Soon',
