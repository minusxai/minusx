...
const TEMPLATE_PATH = join(SCRIPT_DIR, '../lib/database/workspace-template.json');
const PREVIEW_PATH  = join(SCRIPT_DIR, '../lib/database/workspace-template.preview.json');
