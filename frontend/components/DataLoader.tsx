...
export function DataLoader() {
  ...
  useEffect(() => {
    try {
      const flags: { showDebug?: boolean; showJson?: boolean; showAdvanced?: boolean; queueStrategy?: 'end-of-turn' | 'mid-turn'; showSuggestedQuestions?: boolean; showTrustScore?: boolean } = {};
