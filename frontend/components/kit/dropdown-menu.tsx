...
// Inline SVG replacements for lucide-react icons (repo convention: lucide-react is not
// installed; same className wiring so the stock shadcn classes apply).
...
function CircleIcon(props: React.ComponentProps<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" {...props}>
