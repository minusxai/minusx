import { Conversation, UserMessage, CompletedToolCall, DebugMessage, AutoGeneratedMessage } from '@/store/chatSlice';

// Extended types for messages with additional state flags
export type MessageWithFlags = (UserMessage | CompletedToolCall | DebugMessage | AutoGeneratedMessage) & {
  isStreaming?: boolean;
  isPending?: boolean;
};
