    ...
    <VStack gap={3} align="stretch">
      ...
      <Box>
        ...
        <Input
          ...
          placeholder="(optional — leave blank to use IAM role)"
          fontFamily="mono"
        />
      </Box>
      ...
      <Box>
        ...
        />
        <Text fontSize="xs" color="fg.muted" mt={1}>
          Leave both key fields blank to authenticate via IAM role
        </Text>
      </Box>

      <Box>
        <Text fontSize="sm" fontWeight="700" mb={2}>Default Schema / Database</Text>
        <Input
