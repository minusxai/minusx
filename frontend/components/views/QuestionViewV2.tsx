...
interface QuestionViewV2Props {
  ...
  // convention — see AGENTS.md "Component Patterns"). Page-mode containers
...
export default function QuestionViewV2({
  ...
  // on its connection (`frontend/lib/semantic/AGENTS.md` — models are authored,
  // not derived from the schema, so this is a human-sized set fetched unscoped).
