...
#
#   curl -fsSL minusx.ai/setup.sh | bash              # stable
...
#   and this behaves exactly like the old install.sh.
...
printf "  ${DIM}  curl -fsSL minusx.ai/setup.sh | bash${RESET}  ${GRAY}# upgrade${RESET}\n"
printf "\n"
