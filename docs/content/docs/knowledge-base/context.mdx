...
When Custom Agents is enabled, **Agents** appears in the main sidebar and opens the Agents page for the nearest applicable Knowledge Base. Agents defined by parent Knowledge Bases are inherited by child folders.

- **Viewers** can inspect agents and use the Play button to start an Explore conversation with one.
- **Editors and admins** can also add, edit, publish, or remove agents from the Knowledge Base.
