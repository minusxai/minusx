...
Beyond raw tables, you can create **Views** right here — curated SQL exposed as clean, flat tables. A View is whitelisted like a table (down to individual columns) and can back the GUI. Reach for one when a question needs a join or shape the semantic layer can't express. See [Data Modeling](/docs/data/data-modeling) for the full picture.
...
- The **root context** whitelists tables and [Views](/docs/data/data-modeling) from your connections
