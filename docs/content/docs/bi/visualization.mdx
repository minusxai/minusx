...
- **Saved charts are self-contained** — applying a recipe stores the fully built chart spec in the
  question. Renaming, editing, or deleting the recipe file never changes or breaks existing charts;
  re-apply the recipe to pick up an updated design.
