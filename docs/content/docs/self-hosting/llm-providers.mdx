...
The recommended starting points (also offered by the `setup.sh` interview — this table renders from the same [compatibility.json](https://github.com/minusxai/minusx/blob/main/frontend/compatibility.json) the script uses):
