...
- MinusX is [installed and running](/docs/self-hosting/installation), or you have access to a hosted instance
...
- **MCP** — connect Claude, ChatGPT, or Cursor to query your data from your AI coding assistant
